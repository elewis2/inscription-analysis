# This project uses the Inscriptions of Aphrodisias dataset (available from http://insaph.kcl.ac.uk in epidoc xml format) which looks for changing character frequency (in epigraphs) over time.
